/**
 * Custom category page for "Chassis Systems" category.
...
export default async function ChassisSystemsCategoryPage(props: Props) {
    ...
    <>
      ...
      <section className="relative w-full">
        <div className="relative h-[400px] w-full overflow-hidden @xl:h-[500px] @2xl:h-[600px]">
          ...
          <Image
            src={imageManagerImageUrl('chassis-systems-mobile.jpeg')}
            alt={category.name}
            fill
          ...
          />
          <Image
            src={imageManagerImageUrl('chassis-systems-desktop.jpeg')}
            alt={category.name}
            fill
