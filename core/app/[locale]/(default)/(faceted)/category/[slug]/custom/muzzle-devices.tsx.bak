/**
 * Custom category page for "Muzzle Devices" category.
...
export default async function MuzzleDevicesCategoryPage(props: Props) {
    ...
    <>
      ...
      <section className="relative w-full">
        <div className="relative h-[400px] w-full overflow-hidden @xl:h-[500px] @2xl:h-[600px]">
          ...
          <Image
            src={imageManagerImageUrl('muzzle-devices-mobile.jpeg')}
            alt={category.name}
            fill
          ...
          />
          <Image
            src={imageManagerImageUrl('muzzle-devices-desktop.jpeg')}
            alt={category.name}
            fill
