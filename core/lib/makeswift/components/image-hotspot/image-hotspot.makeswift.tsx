...
import { ImageHotspot, HotspotData } from './index';
...
runtime.registerComponent(
  function MSImageHotspot({ image, imageAlt, showHotspots, hotspots, className }: MSImageHotspotProps) {
    ...
    const transformedHotspots: HotspotData[] = hotspots?.map((hotspot) => ({
      ...
      image: hotspot.image && hotspot.image.trim() !== '' ? {
        src: hotspot.image,
